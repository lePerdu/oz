...
pub const bootinfo_start: u64 = 0xFFFF_FFFF_FFE0_0000;
...
// Boot info structure based of Bootboot's
pub const Info = extern struct {
    ...
    /// Maximum number of memory map entries that can fit in the Bootinfo structure
    /// on a single page
